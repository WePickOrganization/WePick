...
%% Change these:
\newcommand{\projecttitle}{WePick -- A dynamic web app that creates curated playlists based on multiple user's music preferences using Spotify}
\newcommand{\projectauthor}{Edward Eldridge \\[0.2cm] Danielis Joniskis \\[0.2cm] Keith Higgins}
\newcommand{\projectadvisor}{Martin Kenirons}
