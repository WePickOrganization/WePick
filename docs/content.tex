...
\begin{itemize}
  ...
  Some of these proposed metrics include
    ...
    From the above graph, we can see that when performin a search in the database, NoSQL databases like Mongo are considerably faster than a traditional SQL database /cite{SQLvsNOSQL}
